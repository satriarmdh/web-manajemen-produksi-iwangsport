...
class UpdateEstimasiProduksiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bahan_baku_id'  => 'required|exists:bahan_baku,id|unique:estimasi_produksi,bahan_baku_id,' . $this->route('estimasi_produksi')->id . ',id,produk_id,' . $this->route('estimasi_produksi')->produk_id,
