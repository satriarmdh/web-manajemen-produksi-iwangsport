                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative pointer-events-none">
                                ...
                                <input type="text" id="edit_satuan_input" readonly placeholder="Otomatis mengikuti kategori..." autocomplete="off" class="w-full px-4 py-2.5 pr-10 border border-gray-300 rounded-xl bg-gray-50 transition-colors text-sm text-gray-600 cursor-not-allowed">
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                    <svg class="dropdown-arrow w-5 h-5 text-gray-400 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="stok_minimal" id="edit_stok_minimal" min="0" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-1 focus:ring-[#0F034D]/20 focus:border-[#0F034D] transition-colors text-sm">
                            <p class="text-xs text-gray-400 mt-1">0 = tidak aktif</p>
                        </div>
                    </div>
                    <div>
