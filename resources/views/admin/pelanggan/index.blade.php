                                ...
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="action-dropdown w-40 bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.12)] border border-gray-100 opacity-0 scale-95 pointer-events-none transition-all duration-200 z-50 origin-top-right hidden py-1">
                                            ...
                                            <button type="button" data-swal-delete data-url="{{ route('admin.pelanggan.destroy', $item->id) }}" data-method="DELETE" data-message="Pelanggan '{{ $item->nama_pelanggan }}' akan dihapus. Data terkait mungkin akan terpengaruh." class="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-red-500 hover:bg-red-50 transition-colors cursor-pointer">
