<x-layouts.admin>
    ...
    <script>
        ...
        function saveItem() {
            ...
            if (qty > product.stok) return showItemError(`Jumlah melebihi stok tersedia (${product.stok} pcs).`);
        ...
        function renderItems() {
            ...
            if (!items.length) {
                body.innerHTML = '<tr id="empty-item-row"><td colspan="6" class="py-8 text-center text-sm text-gray-400">Belum ada produk ditambahkan.</td></tr>';
            } else {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            @if(old('pelanggan_id'))
                setCustomDropdownValue('pelanggan', '{{ old('pelanggan_id') }}');
            @endif
        });
    </script>
</x-layouts.admin>
