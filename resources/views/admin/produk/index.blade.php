        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-8">
            <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl transform scale-95 transition-transform duration-300 flex flex-col max-h-[90vh]">
                ...
                <div class="p-6 border-b border-gray-100 flex items-center justify-between shrink-0">
                    <h3 class="text-lg font-bold text-[#0F034D]">Tambah Produk</h3>
                ...
                <div class="p-6 overflow-y-auto">
                    <form action="{{ route('admin.produk.store') }}" method="POST" id="addForm">
                        @csrf
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Kode Produk</label>
                                <div class="relative">
                                    <input type="text" id="add_kode_produk" disabled data-next-number="{{ $nextNumber }}" placeholder="Dibuat otomatis oleh sistem" class="w-full px-4 py-2.5 border border-gray-300 bg-gray-50 text-gray-500 rounded-xl text-sm italic cursor-not-allowed transition-colors duration-300">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Kode akan di-generate otomatis (Misal: CLN-001).</p>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="ukuran" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-1 focus:ring-[#0F034D]/20 focus:border-[#0F034D] transition-colors text-sm bg-white cursor-pointer">
    ...
    <div id="edit-modal" class="fixed inset-0 z-50 hidden opacity-0 transition-opacity duration-300">
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-8">
            <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl transform scale-95 transition-transform duration-300 flex flex-col max-h-[90vh]">
                ...
                <div class="p-6 border-b border-gray-100 flex items-center justify-between shrink-0">
                    <h3 class="text-lg font-bold text-[#0F034D]">Edit Produk</h3>
                    ...
                    <form action="" method="POST" id="editForm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-1">Ukuran <span class="text-red-500">*</span></label>
                                    <select name="ukuran" id="edit_ukuran" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-1 focus:ring-[#0F034D]/20 focus:border-[#0F034D] transition-colors text-sm bg-white cursor-pointer">
                                        <option value="normal">Normal</option>
                                        <option value="jumbo">Jumbo</option>
                                    </select>
                                </div>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Stok tidak dapat diubah manual. Perubahan stok dilakukan melalui modul Hasil Produksi dan Penjualan.</p>
                            </div>
                        </div>
                    </form>
                </div>
