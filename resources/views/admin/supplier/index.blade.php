<x-layouts.admin>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <button type="button"
                                            ...
                                            data-status="{{ $supplier->is_aktif ? 'aktif' : 'nonaktif' }}"
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="action-dropdown w-40 bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.12)] border border-gray-100 opacity-0 scale-95 pointer-events-none transition-all duration-200 z-50 origin-top-right hidden py-1">
                                            <button type="button"
                                                    ...
                                                    data-alamat="{{ $supplier->alamat }}"
                                                    data-catatan="{{ $supplier->catatan }}"
                                                    data-is-aktif="{{ $supplier->is_aktif ? '1' : '0' }}"
                                            ...
                                            <button type="button" data-swal-delete data-url="{{ route('admin.supplier.destroy', $supplier->id) }}" data-method="DELETE" data-message="Supplier '{{ $supplier->nama_supplier }}' akan dihapus. Data terkait mungkin akan terpengaruh." class="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-red-500 hover:bg-red-50 transition-colors cursor-pointer">
    ...
    {{-- ========================================= --}}
    @include('admin.supplier.partials._tambah-supplier')

    @include('admin.supplier.partials._edit-supplier')

    @include('admin.supplier.partials._detail-supplier')
