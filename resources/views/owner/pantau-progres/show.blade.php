        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-green-50 rounded-xl p-4 border border-green-100">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Akumulasi hasil potong kain utama</p>
                </div>
                        ...
                        <div class="p-4 space-y-4 overflow-y-auto min-h-0">
                                ...
                                <div class="rounded-xl border border-gray-300 overflow-hidden">
                                    ...
                                    <div class="p-5">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="rounded-lg bg-gray-50 px-3 py-2">
                                                <p class="text-[10px] text-gray-400 mb-0.5">Hasil Potong Pcs</p>
                                                <p class="text-sm font-bold text-[#0F034D]">{{ $detail->qty_pcs_potong ? number_format($detail->qty_pcs_potong) : '-' }} Pcs</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="rounded-xl border border-gray-300 overflow-hidden">
                                <div class="px-5 py-3 border-b border-gray-200">
                                    ...
                                    <p class="text-xs text-gray-500 mt-0.5">Log logistik pengerjaan barang secara detail</p>
                                </div>
                                <div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between gap-3 flex-wrap">
                                    <div class="flex items-center gap-1 bg-gray-100 rounded-lg p-0.5">
                                        ...
                                        <button type="button" data-distribusi-tab="log" class="px-3 py-1.5 text-xs font-semibold rounded-md text-gray-500 hover:text-[#0F034D] transition-all">
                                            Log Serah Terima
                                        </button>
