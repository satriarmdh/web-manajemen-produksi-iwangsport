<x-layouts.owner>
    <x-slot:breadcrumb>
        <li class="flex items-center gap-1.5 text-gray-400">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            <a href="{{ route('owner.users.index') }}" class="hover:text-[#0F034D] transition-colors">Manajemen Pengguna</a>
        </li>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $user->name) }}" required placeholder="Masukkan nama lengkap" class="w-full px-4 py-3 border rounded-xl transition-colors text-sm {{ $errors->has('name') ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-[#0F034D]/20 focus:border-[#0F034D]' }}">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" required placeholder="email@iwangsport.com" class="w-full px-4 py-3 border rounded-xl transition-colors text-sm {{ $errors->has('email') ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-[#0F034D]/20 focus:border-[#0F034D]' }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_hp" value="{{ old('no_hp', $user->no_hp) }}" placeholder="Contoh: 08123456789" class="w-full px-4 py-3 border rounded-xl transition-colors text-sm {{ $errors->has('no_hp') ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-[#0F034D]/20 focus:border-[#0F034D]' }}">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2 sm:gap-3">
                                <div class="relative flex-1">
                                    <input type="radio" id="gender_male" name="jenis_kelamin" value="Laki-laki" class="peer sr-only" required {{ old('jenis_kelamin', $user->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }}>
                                    ...
                                    <label for="gender_male" class="flex items-center justify-center lg:justify-start gap-2 w-full px-3 py-3 border {{ $errors->has('jenis_kelamin') ? 'border-red-300' : 'border-gray-300' }} rounded-xl cursor-pointer hover:bg-gray-50 transition-all text-gray-500 peer-checked:border-[#0F034D] peer-checked:bg-[#0F034D]/5 peer-checked:ring-1 peer-checked:ring-[#0F034D] peer-checked:text-[#0F034D] peer-checked:[&_.radio-circle]:border-[#0F034D] peer-checked:[&_.radio-dot]:scale-100">
                                        ...
                                        <span class="text-sm font-medium pointer-events-none">
                                            <span class="hidden lg:inline">Laki-laki</span>
                                ...
                                <div class="relative flex-1">
                                    <input type="radio" id="gender_female" name="jenis_kelamin" value="Perempuan" class="peer sr-only" required {{ old('jenis_kelamin', $user->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }}>
                                    ...
                                    <label for="gender_female" class="flex items-center justify-center lg:justify-start gap-2 w-full px-3 py-3 border {{ $errors->has('jenis_kelamin') ? 'border-red-300' : 'border-gray-300' }} rounded-xl cursor-pointer hover:bg-gray-50 transition-all text-gray-500 peer-checked:border-[#0F034D] peer-checked:bg-[#0F034D]/5 peer-checked:ring-1 peer-checked:ring-[#0F034D] peer-checked:text-[#0F034D] peer-checked:[&_.radio-circle]:border-[#0F034D] peer-checked:[&_.radio-dot]:scale-100">
                                        ...
                                        <span class="text-sm font-medium pointer-events-none">
                                            <span class="hidden lg:inline">Perempuan</span>
                                            <span class="lg:hidden">P</span>
                                        </span>
                                    </label>
                                </div>
                            </div>
                            @error('jenis_kelamin') <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p> @enderror
                        </div>

                        <div class="sm:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Alamat Lengkap</label>
                            <textarea name="alamat" rows="3" placeholder="Masukkan alamat lengkap" class="w-full px-4 py-3 border rounded-xl transition-colors text-sm resize-none {{ $errors->has('alamat') ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-[#0F034D]/20 focus:border-[#0F034D]' }}">{{ old('alamat', $user->alamat) }}</textarea>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                    ...
                    <div class="space-y-6">
                        <div class="relative">
                            ...
                            <button type="button" id="role_dropdown_btn" class="w-full flex items-center justify-between px-4 py-3 border {{ $errors->has('role') ? 'border-red-300' : 'border-gray-300' }} rounded-xl bg-white focus:outline-none focus:ring-1 focus:ring-[#0F034D]/20 focus:border-[#0F034D] transition-colors cursor-pointer">
                                <div id="role_selected_container" class="flex items-center gap-2">
                                    ...
                                    <span id="role_selected_text" class="text-sm text-gray-500">-- Pilih Peran --</span>
                                </div>
                            ...
                            <div id="role_dropdown_menu" class="absolute z-20 w-full mt-2 bg-white border border-gray-100 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] py-1.5 hidden opacity-0 transition-all duration-200 transform origin-top scale-95">
                                ...
                                <div class="role-option group flex items-center justify-between px-4 py-2.5 mx-1.5 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors [&.is-active]:bg-gray-100" data-value="admin">
                                    ...
                                    <svg class="check-icon w-4 h-4 text-[#0F034D] hidden group-[.is-active]:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                </div>
                        ...
                        {{-- <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password_input" placeholder="Kosongkan jika tidak diubah" class="w-full pl-4 pr-12 py-3 border rounded-xl transition-colors text-sm {{ $errors->has('password') ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-[#0F034D]/20 focus:border-[#0F034D]' }}">
                            ...
                            <p class="text-xs text-gray-500 mt-2">Isi kolom ini hanya jika Anda ingin mereset kata sandi pengguna ini.</p>
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('owner.users.index') }}" class="flex-1 sm:flex-2 px-5 py-3 text-sm font-medium text-center text-gray-600 bg-white border border-gray-300 hover:bg-gray-50 rounded-xl transition-colors">
                        Batal
                    </a>
