                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @if(auth()->id() !== $user->id)
                                        <button type="button" data-swal-delete data-url="{{ route('owner.users.destroy', $user->id) }}" data-method="DELETE" data-message="Akun '{{ $user->name }}' akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan." class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors cursor-pointer" title="Hapus Pengguna">
